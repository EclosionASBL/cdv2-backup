/*
  ...
  1. Changes
    - Fixes the net_balance calculation in calculate_user_balance function
    - Updates to correctly show when the organization owes money to the user

  2. Details
    - Changes net_balance from (pending - credits) to (invoiced - paid - credits)
    - This ensures the balance correctly shows negative values when credits exceed what's owed
*/
