/*
  # Optimize Bank Transaction Reconciliation System
  
  1. Changes
    - Simplify the reconciliation logic to avoid stack depth and timeout issues
    - Add direct payment tracking to invoices table
...
BEGIN
    ...
    WHILE v_processed < v_total_count LOOP
        -- Get a batch of transaction IDs
        ...
        -- Commit the current batch to free up resources
        COMMIT;
    END LOOP;
