    ...
    LOOP
        ...
        EXCEPTION
            WHEN OTHERS THEN
                ...
                RAISE NOTICE 'Erreur lors de la mise à jour de la facture %: %', v_invoice_id, SQLERRM;
        END;
    END LOOP;
    
    RAISE NOTICE 'Statut de paiement mis à jour pour % factures avec des notes de crédit (% erreurs)', v_count, v_error_count;
END;
$$;