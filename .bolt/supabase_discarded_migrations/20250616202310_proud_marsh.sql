/*
  ...
  1. Changes
     - Modify calculate_user_balance function to use total_payments column instead of relying on invoice status
     - This ensures that all payments (including partial and overpayments) are correctly reflected in the financial summary
     - Fixes the issue where total_paid was not including all bank transactions

  2. Benefits
     - More accurate financial reporting
     - Correctly shows all payments received, regardless of invoice status
     - Properly accounts for overpayments
*/
