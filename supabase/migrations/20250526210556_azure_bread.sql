/*
  ...
  1. New Tables
    ...
    - stripe_orders: Records order/payment information
    
  2. Views
    - stripe_user_subscriptions: Filtered view of user's subscription data
    - stripe_user_orders: Filtered view of user's order history
    
  3. Changes
    - Added due_date and reminder_sent columns to registrations table
    - Added RLS policies for data access
*/

-- Add new columns to registrations for payment reminders
