/*
  # Create Financial Dashboard Functions and Views

  1. New Functions
    - `get_financial_dashboard_data` - Main function to get all financial dashboard data
    - `get_available_periodes` - Get available periods from sessions
    - `get_available_centers` - Get available centers
    - `get_available_semaines` - Get available weeks from sessions

  2. Views
    - Creates temporary views for data aggregation

  3. Security
    - Functions are accessible to authenticated users with admin role
*/
