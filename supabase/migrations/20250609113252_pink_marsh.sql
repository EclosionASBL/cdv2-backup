...
DROP POLICY IF EXISTS "Admin users can upload credit notes" ON storage.objects;
DROP POLICY IF EXISTS "Authenticated users can view credit notes" ON storage.objects;
