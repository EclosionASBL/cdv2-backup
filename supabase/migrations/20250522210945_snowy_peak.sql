/*
  # Fix waiting list parent_id references
  
  1. Changes
    - Create a migration to rename parent_id to user_id in waiting_list table
    - Update foreign key constraints
    - Update RLS policies to use user_id instead of parent_id
